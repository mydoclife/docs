...
/**
 * 合并图片
 * [hebingtu description]
 * @param  string $url [description]
 * @return [type]      [description]
 */
function hebingtu($url='https://www.ziyuanbang.com/',$bg_img='bg.jpg',$config=array()){
	// 创建二维码类
	$oPHPQRCode = new PHPQRCodes();
	// 设定配置
	$oPHPQRCode->set_config($config);
	// 创建二维码
	$qrcode = $oPHPQRCode->generate($url);

	header('Content-Type: image/png');//输出协议头
	$dst_path = $bg_img;//背景图
	$src_path = $qrcode;//这是我用的是二维码
	...
	imagecopymerge($dst, $src, 165, 900, 0, 0, $src_w, $src_h, 100);
...
$config = array(
    'ecc' => 'Q',  // L-smallest, M, Q, H-best
    'size' => 12,  // 1-50
    'dest_file' => 'file.png',
    'quality' => 90,
    'logo' => 'logo.png',
    'logo_size' => 80,
    'logo_outline_size' => 10,
    'logo_outline_color' => '#fff',
    'logo_radius' => 10,
    'logo_opacity' => 100,
);

hebingtu($url='https://www.ziyuanbang.com/',$bg_img='bg.jpg',$config);